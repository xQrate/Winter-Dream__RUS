...
init -1 python hide:
    ...
    config.window_title = u"Winter Dream"
    ...
    style.default.font = "PTSans-Regular.ttf"
    ...
    config.main_menu_music = "audio/music/pocketsound/Invited To The Springy Earth.mp3"
...
python early:
    config.save_directory = "Winter Dream"

define config.window_icon = "ui/window_icon.png"
...
init -1 python hide:
    ...
    style.say_label.font = "PTSans-Regular.ttf" 
    style.say_label.size = 50
    style.say_label.outlines = [(1, "#4E4E4E", 0, 0)]
...
init python:
    ...
    build.directory_name = "Winter_Dream-1.1"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "Winter_Dream"
